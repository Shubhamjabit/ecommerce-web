...
function CartItems({}) {
  ...
  console.log("iiiiiiiii deleteId", deleteId);
  ...
  const handleRemoveItem = (id) => {
    console.log("iiiiiiiii handleRemoveItem", deleteId);
    setLoadData(true);
  ...
  const handleMoveToWishlist = (product) => {
    const cableLength = cartData && cartData.length > 0 && cartData[0].cableLength ? cartData[0].cableLength : null;
    console.log("cableLengthx", cableLength);
    ...
    const data = {
      ...
      product_price: 
         (product.cable_pricing_permeter * (cableLength || 0)) + product.pricelist[0].price,
      product_cable_price_per_meter: product.cable_pricing_permeter,
      user_id: user.id,
      user_email: user.email,
      product_cable_length: cableLength || 0,
    };
  
    console.log("Shudata", data);
    addToWishlist(data);
        ...
        <Grid className={Styles.cardItemSection}>
          ...
          >
            <Col
              ...
              span={15}
              style={{ paddingLeft: "0px !important", paddingRight: "0px" }}
            >
              <Typography
                variant="h5"
                component="h2"
                ...
                cartData.map((item, index) => (
                  <>
                    <ItemCard
                      ...
                      handleDeleteButton={(id) => handleDeleteButton(id)}
